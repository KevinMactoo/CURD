 ...
 <tr id="<?php echo $row["id"]; ?>">
   <td>
     <span class="custom-checkbox">
         ...
         <tr id="<?php echo $row["id"]; ?>"></td>
         <tr id="<?php echo $row["name"]; ?>"></td>
         <tr id="<?php echo $row["email"]; ?>"></td>
         <tr id="<?php echo $row["phone"]; ?>"></td>
         <tr id="<?php echo $row["city"]; ?>"></td>
           <td>
			...
			<div class="modal-content">
				<form>
					...
					<div class="modal-body">
						...
						<p>Are you sure you want to delete these student's Records?</p>
